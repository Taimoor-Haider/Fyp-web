...
function HotelEditPage() {
  ...
  const handlePriceChange = (e) => {
    ...
    if (
      inputValue === "" ||
      parseFloat(inputValue) < 250 ||
      parseFloat(inputValue) > 100000
    )
      alert("Price Must be between PKR 250 and PKR 1,00,000");
    else {
  ...
  const handleRoomsChange = (e) => {
    ...
    if (inputValue === "" || parseFloat(inputValue) >= 1) {
      ...
      setHotel({ ...hotel, numberOfRooms: inputValue });
    }
  };
    ...
    <div>
      ...
      {editLoading ? (
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div>
            <div className="mb-1 block">
              <Label htmlFor="numberOfRooms" value="Number of Rooms" />
            </div>
            <TextInput
              id="numberOfRooms"
              type="number"
