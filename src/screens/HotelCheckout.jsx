...
function HotelCheckout() {
  ...
  const { selectedDates, paymentType, numberOfDays, numberOfRooms } =
    useSelector(checkAvailibilitySlector);
  ...
  const handleBooking = (paymentMethod) => {
    const bookedItem = {
      item: hotel._id,
      price: hotel.price * numberOfDays * numberOfRooms,
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div>
                <p className="font-bold text-[1.5rem] tracking-widest">
                  Rs: {hotel?.price * numberOfDays * numberOfRooms} Rs/-
                </p>
              </div>
            </div>
          </div>
